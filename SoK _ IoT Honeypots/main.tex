...
\author{Shreyas Srinivasa$^{1}$ and Emmanouil Vasilomanolakis$^{2}$% <-this % stops a space
%\thanks{*This work was not supported by any organization}% <-this % stops a space
\thanks{$^{1}$S. Srinivasa is PhD Fellow at Department of Electronic Systems,
        Aalborg University, Copenhagen, Denmark
        {\tt\small shsr@es.aau.dk}}%
\thanks{$^{2}$E. Vasilomanolakis is Asst. Professor at Department of Electronic         Systems,Aalborg University, Copenhagen, Denmark
        {\tt\small emv@es.aau.dk}}%
}
